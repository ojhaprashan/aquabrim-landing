  ...
  return (
    <html lang="en">
      ...
      <head>
        ...
        {/* Only the weights actually used (300-800, no italics — the codebase
            has no italic type). Was 14 variants; 8 of them were never used and
            each one is a font file the browser may fetch. */}
        <link
          rel="stylesheet"
