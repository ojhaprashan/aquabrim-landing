...
import shipping_banner_img from "@/assets/images/policy/shipping.png";

const ShippingPolicyBanner = () => {
  return (
    <section className="policy-banner-section d-flex align-items-center hero-new-bg" style={{ width: '100%', minHeight: '320px', position: 'relative', padding: '110px 0' }}>
       {/* Background Image */}
       <div className="position-absolute top-0 start-0 w-100 h-100" style={{ zIndex: 0 }}>
          <Image 
            src={shipping_banner_img} 
             ...
             <div className="col-12 col-lg-7">
                <div className="slider-content" style={{ visibility: 'visible', opacity: 1 }}>
                   ...
                   <p className="mb-0" style={{ color: '#475569', maxWidth: '500px', lineHeight: '1.4', fontSize: '15px' }}>
                      Learn how we process and deliver your Aquabrim orders.
                   </p>
                </div>
             </div>
          </div>
